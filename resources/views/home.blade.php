    ...
    <div class="row mt-3">
        <div class="col-md-8">
                ...
                <div class="mt-3">
                    ...
                    <div class="">
                        <p class="text-muted font-italic" style="margin: 0px; padding: 0px;">
                            ...
                            designen zodat je een soepel werkende applicatie krijgt.
                        </p>
                    </div>
                </div>
            ...
            <div class="mt-5" style="max-width: 50vw;">
                ...
                <div>
                    <a href="/bijlage/oorkonde.pdf">Oorkonde World Skills</a>
                </div>
        ...
        <div class="col-6 col-md-4">
            <div class="">
                ...
                <div class="">
                    <div>
                        <i class="fab fa-bootstrap fs-4"></i>
                        Bootstrap
                    </div>
                    <div class="progress">
                ...
                <div class="mt-3">
                    <div>
                        <i class="fab fa-uncharted fs-4"></i>
                        Adobe XD
                    </div>
                    <div class="progress">
            ...
            <div class="mt-5">
                <h3 class="bold">Programmeer 'talen'</h3>

                <div class="mt-3">
                    <div>
                        <i class="fab fa-html5 fs-4"></i>
                        HTML
                    </div>
                    <div class="progress">
                ...
                <div class="mt-3">
                    <div>
                        <i class="fab fa-css3-alt fs-4"></i>
                        CSS
                    </div>
                    <div class="progress">
